  ...
  return (
    <div>
      ...
      <div id="right" style={{fontSize:"20px"}}>
          <div style={{marginTop:"60px",marginLeft:"-300px",textAlign:"center",display:"flex",justifyContent:"center",alignItems:"center"}}> <img src="https://www.kindmeal.my/images/icon_tick.png"/><p style={{marginLeft:"20px",fontSize:"30px"}}>Signup Successful</p></div>
          <br/>
          <p>Congratulations {details.firstName}, you're now ready to get started on KindMeal.my</p>
          <br/>
          <p>
          A verification email has been sent to {details.email} Please click on the link there to activate your account and begin redeeming coupons.
          </p>
          <br/>
          <p>Yummy meals are waiting for you!</p>
          <br/>
          <br/>
          <button id="btn" onClick={()=>navigate("/deals")}>Login to Account</button>
      </div>
      </div>
      </div>
