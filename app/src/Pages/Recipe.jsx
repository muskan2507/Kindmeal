        ...
        <div className={style.food}>
             ...
             <div className={style.child_div}>
              <img src={show.img}/>
               <div>
                  ...
                  <div style={{display:"flex"}}>
                        <div className={style.inner}>
                            <p> Diet Restriction <img src="https://www.kindmeal.my/images/icon_help.png"/></p>
                        </div>
                        <div className={style.inner}>
                            <p>Ratings</p>
                            <div style={{display:'flex'}}>
                  ...
                  <p style={{marginTop:"5px"}}>	Like this recipe & share with friends!</p>
           ...
           <div className={style.child_div}>
                         ...
                         <div className={style.inner1}>
                             <p>Direction</p>
                             <ol>
                                  <li>In a large bowl, combine the flour, soda and salt. I a mixing bowl, beat 1-1/2 cups sugar and oil. Beat in eggs and buttermilk until combined. Stir into dry ingredients just until moistened. Fold in raisins. Combine cinnamon and remaining sugar; set aside.</li>
                            <li>Spoon half of the better into two greased 8-in x 4-in x 2-in loaf pans. Sprinkle with half of the reserved cinnamon-sugar mixture; repeat layers. Cut through batter with a knife to swirl. Bake at 350 degrees for 55-60 minutes or until a toothpick inserted near the center comes out clean. Cool in pans for 10 minutes before removing from pans to wire racks.</li>
                             </ol>
                         </div>
               </div>
        </div>
        <br/><br/>
        <div style={{width:"70%",margin:"auto"}}><img src="https://www.kindmeal.my/images/ads/banner_ekoeko-1100x280.jpg"/></div>        <br/><br/>
