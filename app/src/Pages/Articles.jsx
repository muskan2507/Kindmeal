...
const Articles = () => {
  ...
  useEffect(() => {
    const getData = async () => {
      ...
      try {
        let res = await fetch(`http://localhost:8080/articles?_page=${pageNumber}&_limit=5`)
  ...
  return (
    <>
      ...
      <Pagination>
        ...
        <PButton onClick={()=>setPageNumber(pageNumber-1)} style={{marginLeft:"420px"}}>« Prev</PButton>
