            ...
            
{
    show.map((item)=>(
        <div>
            <div className={style.head_div}>
                <img src="https://www.kindmeal.my/images/default_member_cover-1.jpg" alt="banner" />
            ...
            <div className={style.progress_div}>
                ...
                <div className={style.progress_child}>
                    <h4 className={style.lives_saved}>Lives Saved
                ...
                <div >
                    <div className={style.flex}>
                        <h4 className={style.lives_saved}>Power Level : 1 XP
                            <span className={style.question_mark}>&#63;</span>
                        </h4>
                    </div>
                ...
                <div>
                    <h4 className={style.lives_saved}>Superhero Rank
                        <span className={style.question_mark}>&#63;</span>
                    </h4>
                    <div className={style.batman_div}>
                         <img src="https://www.kindmeal.my/images/minion-batman-thumb.png" alt="super hero" />
                            ...
                            <h5>Level 1</h5>
                             <p>Earn 49 XP more to transform into Captain America!</p>
                                ...
                                <div className={style.Share_tweet}>
                                    <button> <img src="https://www.kindmeal.my/images/icon_button_fb.png" alt="fb" />
                                        Share</button>
                                    <button><img src="https://www.kindmeal.my/images/icon_button_twitter.png" alt="tw" />
                                        Tweet</button>
                                 </div>
                        </div>
                    </div>
    ...
    <div>
        <h3>About <span className={style.about_span}>{item.firstName}</span></h3>
        <p>We're as excited as you are to find out more about debobrota, but this info has not been completed yet.</p>
