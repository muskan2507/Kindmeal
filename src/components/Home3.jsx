...
function Home3() {
  ...
  return (
    <div>
          ...
          <tr>
            <td width="25%" align="center" valign="middle">
              <div className={style.intro_feature}>
                ...
                <br />
                Get Great Deals
                <div style={{fontSize:"14px", color:"#888888", marginTop:"5px"}}>
      ...
      <center>
         <div style={{height:"250px", backgroundColor:"#ececec", width:"100%", textAlign:"center", verticalAlign: "top", marginTop:"0px"}}>
