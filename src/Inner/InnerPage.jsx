...
const InnerPage = () => {
  return (
    <div>
        <div>
        <div>
        <img className={styles.BannerImg} src="https://www.kindmeal.my/photos/shop/2/244-c.jpg" alt="" />
        
        <div className={styles.BanneroverHead}><h1>MBG Fruit Shop</h1></div>
        <div id={styles.overBanner}>
            <div>
            <img src="https://www.kindmeal.my/photos/shop/2/244-1236-l.jpg" alt="logo" />
            </div>
